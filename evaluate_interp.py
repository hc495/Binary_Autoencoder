...
parser.add_argument("--BAE_path", type=str, default="experiment_matrial/model_20250628_215637_076289.pt", help="Path to the Binary Autoencoder feature set")
parser.add_argument("--type", type=str, default="BAE", help="Type of the model to use for feature extraction, SAE, BAE, TRC, random")
parser.add_argument("--config_path", type=str, default="experiment_matrial/log_20250628_215637_076289.pkl", help="Path to the configuration file for the Binary Autoencoder")
